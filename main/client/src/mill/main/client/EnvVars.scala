...
object EnvVars {
   ...
   */
  val MILL_TEST_RESOURCE_DIR = "MILL_TEST_RESOURCE_DIR"

  /**
   * How long the Mill background server should run before timing out from inactivity
   */
  val MILL_SERVER_TIMEOUT_MILLIS = "MILL_SERVER_TIMEOUT_MILLIS"

  val MILL_JVM_OPTS_PATH = "MILL_JVM_OPTS_PATH"
  val MILL_OPTS_PATH = "MILL_OPTS_PATH"

  /**
   * Output directory where Mill workers' state and Mill tasks output should be
   * written to
   */
  val MILL_OUTPUT_DIR = "MILL_OUTPUT_DIR"
   ...
   */
  val MILL_WORKSPACE_ROOT = "MILL_WORKSPACE_ROOT"
