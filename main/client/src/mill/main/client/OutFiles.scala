...
object OutFiles {
  ...
  private val envOutOrNull = System.getenv(EnvVars.MILL_OUTPUT_DIR)
   ...
   */
  val out = Option(envOutOrNull).getOrElse(defaultOut)
   ...
   */
  val millChromeProfile = "mill-chrome-profile.json"
